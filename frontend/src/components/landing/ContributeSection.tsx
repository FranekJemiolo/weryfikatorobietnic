...
const WAYS = [
  {
    ...
    description:
      "Nie jesteś programistą? Dołącz plik Markdown do folderu `ideas/` w repo. Opisz obietnicę partii i podaj źródło — resztą zajmie się pipeline.",
    cta: "Przeglądaj ideas/",
    href: "https://github.com/FranekJemiolo/traceplay/tree/main/ideas",
  ...
  },
  {
    ...
    description:
      "Backend w FastAPI + SQLModel, DAGi Airflow, scraper RSS? Otwórz issue albo fork repozytorium. Przyjmujemy testy, refactoring i nowe źródła danych.",
    cta: "Otwórz issue",
    href: "https://github.com/FranekJemiolo/traceplay/issues/new",
  ...
  },
  {
    ...
    description:
      "Każda ocena AI może być zakwestionowana. Zbieramy feedback obywatelski do doskonalenia modeli. Jeśli widzisz błędny werdykt — oznacz go.",
    cta: "Sprawdź obietnice",
    href: "/promises",
